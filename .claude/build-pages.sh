#!/usr/bin/env bash
# Wrap the self-contained app fragment (app.html) into a standalone PWA index.html.
# app.html stays the single source of truth (also publishable as a claude.ai Artifact).
set -uo pipefail
